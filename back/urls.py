...
urlpatterns = [
    ...
    path('products/aguardiente', product_views.product_list_aguardiente, name='product_list'),
    path('products/ron', product_views.product_list_ron, name='product_list'),
    path('products/whiskey', product_views.product_list_whiskey, name='product_list'),
    path('products/ginebra', product_views.product_list_ginebra, name='product_list'),
    path('products/tequila', product_views.product_list_tequila, name='product_list'),
    path('products/create', product_views.product_create, name='product_create'),
    path('products/cocteles', product_views.product_list_cocteles, name='product_list'),
    path('products/vino', product_views.product_list_vino, name='product_list'),
    path('products/champagne', product_views.product_list_champagne, name='product_list'),
